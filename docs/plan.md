...
| Goroutine leak and response corruption fix                                                                                                                                                                                                                                | Done   | Joshua — PR #62 (open, not yet merged)   |
| Graceful shutdown race: metrics flush before exit                                                                                                                                                                                                                         | Done   | Issue #63 — blocked on PR #62 merge      |
...
| 2.1       | Run round-robin baseline (Exp 1)             | Both             | Done   |
| 2.2       | Run least-connections comparison (Exp 1)     | Both             | Done   |
| 2.3       | Run weighted comparison (Exp 1)              | S Karthikeyan S. | Done   |
| 2.4       | Collect metrics snapshots (Exp 1)            | Both             | Done   |
| 2.5       | Run retries-enabled chaos test (Exp 2)       | Joshua           | Done   |
| 2.6       | Run retries-disabled chaos test (Exp 2)      | Joshua           | Done   |
| 2.7       | Capture error rate differential (Exp 2)      | Joshua           | Done   |
| 2.8       | Single LB instance baseline (Exp 3)          | S Karthikeyan S. | Done   |
| 2.9       | Scale to 2 LB instances (Exp 3)              | S Karthikeyan S. | Done   |
| 2.10      | Scale to 4 LB instances (Exp 3)              | S Karthikeyan S. | Done   |
| 2.11      | Scale to 8 LB instances (Exp 3)              | S Karthikeyan S. | Done   |
| 2.12      | Spike load test at each scale (Exp 3)        | S Karthikeyan S. | Done   |
| 3.1       | Process Locust CSV exports                   | Joshua           | Done   |
| 3.2       | Experiment 1 charts (algorithm comparison)   | Both             | Done   |
| 3.3       | Experiment 2 charts (chaos/retry comparison) | Joshua           | Done   |
| 3.4       | Experiment 3 charts (scaling efficiency)     | Joshua           | Done   |
| 3.5       | Per-backend load distribution analysis       | Joshua           | Done   |
| 3.6       | Statistical summary and confidence intervals | Joshua           | Done   |
| 4.1       | Write introduction and architecture section  | Joshua           | Done   |
| 4.2       | Write implementation section                 | S Karthikeyan S. | Done   |
| 4.3       | Write experiment methodology section         | Joshua           | Done   |
| 4.4       | Write results and analysis section           | Joshua           | Done   |
| 4.5       | Write conclusions section                    | Joshua           | Done   |
| 4.6       | Prepare presentation slides                  | Joshua           | Done   |
| 4.7       | Rehearse demo                                | Both             | Done   |
